#
#  Be sure to run `pod spec lint SamplePod_SVGKit.podspec' to ensure this is a
...
#s.license      = "MIT (example)"
  ...
  # Or just: s.author    = "Sujit Kaulavkar"
  # s.authors            = { "Sujit Kaulavkar" => "sujit.kaulavkar@perennialsys.com" }
  # s.social_media_url   = "http://twitter.com/Sujit Kaulavkar"
